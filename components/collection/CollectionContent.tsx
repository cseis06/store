...
import { CollectionWithProducts } from "@/types/product";
  ...
  return (
    <div className="min-h-screen">
      ...
      >
        ...
        {/* 
          Descomentar cuando tengas las imagenes:
          <Image
        ...
        {sortedProducts.length > 0 ? (
          ...
          <div className="text-center py-20">
            <p className="font-inter text-black/60 mb-4">
              No hay productos en esta coleccion todavia.
            </p>
            <Link
              href="/colecciones"
      ...
      <section className="bg-black/[0.02] py-16 lg:py-20">
        <div className="container-kiren">
          ...
          <p className="font-inter text-black/60 text-center mb-10">
            Descubri mas propuestas de nuestra marca
          </p>
